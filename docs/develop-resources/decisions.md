...
| Stateful Reconciliation | Use `status.lastModifiedCookie` to store hashes of applied spec and observed GCP state to detect changes and drift efficiently. | 2025-09-30 | Deprecated | [Link](../designs/stateful-reconciliation-with-cookie.md) |
